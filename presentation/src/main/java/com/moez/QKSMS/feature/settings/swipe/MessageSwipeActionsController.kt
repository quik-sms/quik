...
class MessageSwipeActionsController : QkController<SwipeActionsControllerBinding, MessageSwipeActionsView, MessageSwipeActionsState, MessageSwipeActionsPresenter>(), MessageSwipeActionsView {
    ...
    @Inject override lateinit var presenter: MessageSwipeActionsPresenter
    ...
    init {
        ...
        actionsDialog.adapter.setData(R.array.settings_message_swipe_actions)
    }
    ...
    override fun onAttach(view: View) {
        ...
        setTitle(R.string.settings_message_swipe_actions)
        showBackButton(true)
    }
